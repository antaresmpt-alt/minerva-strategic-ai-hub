...
> **No es la fuente de verdad del módulo.** Eso sigue siendo `MINERVA_BLOQUE9_REASIGNACION_STOP.md`.
...
|-----------|------------|
| `MINERVA_BLOQUE9_REASIGNACION_STOP.md` | §12 98020 + §18 backlog |
| `MINERVA_HUB_CONTEXTO_MAESTRO.md` | Estado 9.8 + sesión 19 ago |
| `FASES_HOJA_RUTA_DIGITAL.md` | Tabla fases 9.8 |
| `SESION_18AGO2026_STOP_MATERIAL.md` | Enlace a 98020 validado |
