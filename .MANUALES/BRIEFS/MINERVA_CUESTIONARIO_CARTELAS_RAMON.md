...
- **Arranque:** piloto en paralelo con Optimus (10–20 OTs en Minerva); ver §13c en `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md`.

**Documentación técnica:** `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md`
...
*Generado desde `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` — Bloque 9 Minerva Hub. Respuestas incorporadas 24 jun 2026.*
...
Detalle técnico, archivos y smoke test: **`.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §15**.
