...
> **Briefing completo:** `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md` §8.2 / §16  
> **Pendiente CTP despacho:** `docs/despacho-wizard-ctp-pendiente.md` — ✅ **v1 implementado** (30 jun 2026)  
> **Pedidos complejos / demo:** `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md` **§3 Caso A.2 — OT 36204**
...
Tener a mano `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md` §12:
...
OT simple validada de punta a punta. Ver `.MANUALES/CONTEXTO/FASES_HOJA_RUTA_DIGITAL.md` §Bloque 3.9 y `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md` §8.7.1.
...
Ramón respondió el cuestionario (`.MANUALES/BRIEFS/MINERVA_CUESTIONARIO_CARTELAS_RAMON.md`). Decisiones en `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §3g y §13c.
...
**Fuente de verdad:** `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md` §3 **Caso A.2**.
