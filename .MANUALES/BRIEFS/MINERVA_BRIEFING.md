...
> **Documento secundario**: la fuente de verdad maestra es `.MANUALES/CONTEXTO/MINERVA_HUB_CONTEXTO_MAESTRO.md`.
...
> ver el documento complementario **`.MANUALES/CONTEXTO/MINERVA_CONTEXTO_TECNICO.md`**.
>
> Fecha: 13 de junio de 2026.
> Actualizado: 23 jul 2026 — Bloque 6 MVP marcado como operativo; ver handoff en `.MANUALES/BLOQUES/MINERVA_BLOQUE6_HISTORICO_PRODUCIDAS.md` §0.
...
> Para auditoría real de tablas/campos del pipeline ver `.MANUALES/BRIEFS/DATA_MAPPING_PIPELINE_MVP.md`.
...
> Roadmap completo y detallado en **`.MANUALES/CONTEXTO/FASES_HOJA_RUTA_DIGITAL.md`**. Resumen:
...
- **Bloque 6 — Producidas / Histórico + Cierre de OT**: ✅ **MVP operativo (23 jul 2026)** —
  ...
  promedios maestro, cierre contenedor/hijas. Handoff: `.MANUALES/BLOQUES/MINERVA_BLOQUE6_HISTORICO_PRODUCIDAS.md` §0.
...
- **Bloque 8 — Formatos de hoja + formas + componentes** (fuente de verdad, 17 jun 2026): el modelo
  ...
  Briefing: `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md`.
- **Bloque 9 — Material, cartelas y stock** (18 jun): **Fase A** 9.0–9.4 (cartelas, stock real, recepción Emma) primero;
  **Fase B** 9.5+ después (puente muelle+fotos, IA desde albarán). `prod_recepciones_material` ya existe en muelle.
  Briefing: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md`.
...
9. **Trazabilidad de material**: cartelas por palet (ID Stock, proveedor, albarán). Albaranes reales
   ...
   Briefing: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §3b.
...
--- BRIEFING ---
<pegar el contenido de .MANUALES/BRIEFS/MINERVA_BRIEFING.md>
```

Luego, lo que decidáis, vuélcalo a `.MANUALES/CONTEXTO/FASES_HOJA_RUTA_DIGITAL.md` para que Cursor lo ejecute con el
mismo contexto.
...
| Documento | Contenido |
|---|---|
| `.MANUALES/BRIEFS/MINERVA_BRIEFING.md` | **Este documento.** Contexto estratégico/producto para brainstorming. |
| `.MANUALES/CONTEXTO/MINERVA_CONTEXTO_TECNICO.md` | Árbol del proyecto, `package.json`, configs clave, tipos, migraciones, reglas. |
| `.MANUALES/BLOQUES/MINERVA_BLOQUE6_HISTORICO_PRODUCIDAS.md` | Brief específico para diseñar Producidas, histórico, cierre/reapertura de OT y recálculo del Maestro. |
| `.MANUALES/BLOQUES/MINERVA_BLOQUE7_ODOO_ALBARANES.md` | Brief específico para decidir Odoo, expedición, pre-albaranes, entregas parciales e integración futura. |
| `.MANUALES/CONTEXTO/FASES_HOJA_RUTA_DIGITAL.md` | Roadmap detallado por bloques de la Hoja de Ruta Digital (estado y pendientes). |
| `.MANUALES/CONTEXTO/FASES_MAESTRO_ARTICULOS.md` | Plan de fases del Maestro de Artículos. |
| `.MANUALES/BRIEFS/DATA_MAPPING_PIPELINE_MVP.md` | Auditoría real de tablas/campos y contrato de datos del Pipeline. |
| `.MANUALES/BRIEFS/GUIA_MAÑANA.md` | Notas operativas de continuación (Fase 0). |
