...
> Fecha de generación: 13 de junio de 2026 · **Última actualización: 18 agosto 2026** (spec 9.8 STOP; `.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md`; OT 98019).
...
├── AGENTS.md
├── CLAUDE.md
├── .MANUALES/BRIEFS/DATA_MAPPING_PIPELINE_MVP.md
├── .MANUALES/CONTEXTO/FASES_HOJA_RUTA_DIGITAL.md
├── .MANUALES/CONTEXTO/FASES_MAESTRO_ARTICULOS.md
├── .MANUALES/BRIEFS/GUIA_MAÑANA.md
├── README.md
├── components.json
├── eslint.config.mjs
├── next.config.ts
...
**Calendario Producción (UI/PDF, 18 jul):** `calendario-produccion-page.tsx`, `calendario-produccion.ts`, `calendario-produccion-progreso.ts`, `calendario-produccion-export.ts` (PDF grid mes/semana + **listado por día**), `calendario-produccion-import.ts`. Detalle: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §15.11–15.12.
...
Handoff y backlog: `.MANUALES/BLOQUES/MINERVA_BLOQUE6_HISTORICO_PRODUCIDAS.md` **§0**.
...
> Detalle: `.MANUALES/SESIONES/SESION_13AGO2026_DERIVAR_EXTERNA_ITINERARIO.md`.
...
> Detalle: `.MANUALES/SESIONES/SESION_14AGO2026_MANIPULADOS_ENCAJAR.md`.
...
> Detalle: `.MANUALES/SESIONES/SESION_14AGO2026_EJECUCION_LISTA.md`.
