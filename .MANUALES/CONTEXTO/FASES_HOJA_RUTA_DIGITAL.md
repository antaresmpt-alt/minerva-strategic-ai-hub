...
**👉 Retomar aquí:** **Demo pedidos complejos (3 jul 2026)** → desplegar rama **`wizard-despacho`**, guion en `.MANUALES/BRIEFS/GUIA_MAÑANA.md`. OTs: **98010** (ejecución), **98011** (wizard en vivo), **36204** (despachada + desbroce).
...
### Pendiente
- Demo 3 jul: guion `.MANUALES/BRIEFS/GUIA_MAÑANA.md` § recorrido ampliado.
...
### Hecho
- **§3 Caso A.2** en `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md`: ampollas 4 modelos, 2 formas, troquel 4 poses, validaciones, mock wizard, desbroce, SQL componentes.
...
- Guía demo: `.MANUALES/BRIEFS/GUIA_MAÑANA.md`.
...
- **Bloque 9 §3b**: insights albaranes CARPAPSA + Papers Tordera documentados en `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` (stock al recepcionar, kilos→hojas, ID 10.300+, FSC).
...
- [ ] **Bloque 8**: ~~Fase FORMATO~~ ✅ · ~~8.0~~ ✅ → **8.1** agrupación UI — ver `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md`
- [ ] Ampliar campos CTP tras reunión con Gemma.
...
- [ ] **Bloque 8.2+**: wizard despacho contenedor + hijas — ver `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md` §12 (preguntas planta)
- **Bloque 6**: `prod_ot_producidas` + lifecycle de cierre.
...
### Documento
- Fuente de verdad: `.MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md`
...
| **Manipulados** | Checkbox **Etiquetar** + uds./paquete etiqueta; cálculo `num_paquetes` / `num_paquetes_etiqueta`. **14 ago:** Encajar + flags en wizard — `.MANUALES/SESIONES/SESION_14AGO2026_MANIPULADOS_ENCAJAR.md`. |
...
> Fuente: `.MANUALES/BRIEFS/MINERVA_CUESTIONARIO_CARTELAS_RAMON.md` · diseño: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §3g, §13c.
...
> Fuente técnica: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §15.5 · referencia Optimus: `docs/referencias/cartelas-optimus-campo.md`.
...
> Fuente: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §15.6.4.
...
> Fuente: `.MANUALES/SESIONES/SESION_13AGO2026_DERIVAR_EXTERNA_ITINERARIO.md` · `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §15.6.12 / §15.14.
...
> Fuente: `.MANUALES/SESIONES/SESION_14AGO2026_MANIPULADOS_ENCAJAR.md`.
...
Tarde del mismo día (lista gorda / tableta): `.MANUALES/SESIONES/SESION_14AGO2026_EJECUCION_LISTA.md`.

---

## Bloque 9.8 — Reasignación cartelas / STOP material ✅ **lab validado 19 ago 2026**

> Fuente: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md` · sesiones: `.MANUALES/SESIONES/SESION_18AGO2026_STOP_MATERIAL.md` · **`.MANUALES/SESIONES/SESION_19AGO2026_STOP_MATERIAL_98020.md`**
> OT laboratorio: **98019** (caso A, 18 ago) · **98020** (A+B+C, 19 ago). Backlog producto final: brief §18.

Principio: el ledger ATP manda (no las líneas de Optimus); no fiarse de que el usuario marque. Liberar reserva ≠ anular compra.

| Fase | Estado | Notas |
|------|--------|--------|
| 9.8.1 + **9.8.1b** | ✅ | Liberar reserva + allowlist compra — 98019-A + 98020-A |
| 9.8.2 | ✅ | Aviso CTP + Guillotina + Impresión — `acca03b` |
| 9.8.3 | 📋 | Compra corrección P2 — workaround duplicar P1 |
| 9.8.4 | ✅ | Asignar stock libre → OT — 98020-C |
