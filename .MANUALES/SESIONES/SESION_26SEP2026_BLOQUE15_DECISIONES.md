...
2. **Limpieza de nombres.** Misma referencia: cliente del maestro de artículos contra el de las OTs. Una sola grafía en OTs → copiarla al artículo y a los lotes ya creados. Dos grafías distintas → listar, no adivinar.
...
Pendiente de esta tanda: puntos 2, 4, 5 y 7 (SQL con review Claude, Consumir cierra, smoke).
