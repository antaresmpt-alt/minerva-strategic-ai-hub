...
| Fuente detallada mañana | `.MANUALES/SESIONES/SESION_20AGO2026_BACKLOG_P0_STOP.md` |
| Fuente detallada 9.8.3 | `.MANUALES/SESIONES/SESION_20AGO2026_BLOQUE9_8_3_VALIDACION_HOOK.md` |
| Brief módulo | `.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md` |
| Maestro global | `.MANUALES/CONTEXTO/MINERVA_HUB_CONTEXTO_MAESTRO.md` |
...
Detalle exhaustivo: `.MANUALES/SESIONES/SESION_20AGO2026_BACKLOG_P0_STOP.md`.
...
Si alguien pide «validar Camino A otra vez» en contexto 9.8.3: **rechazar** salvo regresión nueva. El checklist teórico en `.MANUALES/SESIONES/SESION_20AGO2026_BLOQUE9_8_3_VALIDACION_HOOK.md` §«Camino A» es histórico de diseño; el smoke real ya está en el backlog P0.
...
| Docs | este archivo · `.MANUALES/SESIONES/SESION_20AGO2026_BLOQUE9_8_3_VALIDACION_HOOK.md` · `.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md` · maestro |
...
1. **9.8.6** — Popup redespacho asistido tras liberar/asignar (hoy: lápiz manual). Brief § en `.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md`.
...
```
Lee en este orden:
1) .MANUALES/SESIONES/SESION_20AGO2026_HANDOFF_NOCHE_CLAUDE.md  (este handoff)
2) .MANUALES/CONTEXTO/MINERVA_HUB_CONTEXTO_MAESTRO.md (estado global)
3) .MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md (brief 9.8)
Si tocas 9.8.3: .MANUALES/SESIONES/SESION_20AGO2026_BLOQUE9_8_3_VALIDACION_HOOK.md
Si tocas smoke P0 mañana: .MANUALES/SESIONES/SESION_20AGO2026_BACKLOG_P0_STOP.md
...
| Inventario botones | `.MANUALES/BRIEFS/INVENTARIO_BOTONES_CARTELAS_STOCK.md` (para manual Claude) |
---
