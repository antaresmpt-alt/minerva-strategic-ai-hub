...
> **Brief relacionado:** Bloque 9 §15.6.12 (`.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md`).  
> **Día siguiente (14 ago):** Encajar / flags wizard / portada — `.MANUALES/SESIONES/SESION_14AGO2026_MANIPULADOS_ENCAJAR.md`.
...
**14 ago (otra sesión):** Encajar en Manipulados + flags wizard + `/produccion` → OTs. Campo Ruta en OT **36286**. Ver `.MANUALES/SESIONES/SESION_14AGO2026_MANIPULADOS_ENCAJAR.md`.
