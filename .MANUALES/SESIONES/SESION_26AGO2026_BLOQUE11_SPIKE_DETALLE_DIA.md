...
> **Brief:** `.MANUALES/BLOQUES/MINERVA_BLOQUE11_DECISION_CALENDARIO_CONTENEDOR.md` §6.5 / §24–25  
...
Otros módulos seguían con `useReactToPrint` — **migrados 27 ago** (`ace0409`). Ver `.MANUALES/SESIONES/SESION_27AGO2026_BLOQUE11_DIA_COMPLETO.md` §3.
...
- No commitear: `.MANUALES/MANUALES_USUARIO/MINERVA_MANUAL_CARTELAS_*`, `MINERVA_MANUAL_RESERVAS_*`, `DISQUISICIONES VARIAS MANEL/`.
...
Ver **día completo 27 ago:** `.MANUALES/SESIONES/SESION_27AGO2026_BLOQUE11_DIA_COMPLETO.md`.
...
**`.MANUALES/SESIONES/SESION_27AGO2026_BLOQUE11_DIA_COMPLETO.md`**
