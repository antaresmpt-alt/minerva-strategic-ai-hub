...
> Sesión anterior: `.MANUALES/SESIONES/SESION_14AGO2026_EJECUCION_LISTA.md` (14 ago tarde).
...
- ~~Desasignar/reasignar cartela~~ → spec **9.8** 18 ago: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md` (OT **98019**).
...
- [x] Cartelas desasignar/reasignar: spec 9.8 (18 ago) — `.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md`.
