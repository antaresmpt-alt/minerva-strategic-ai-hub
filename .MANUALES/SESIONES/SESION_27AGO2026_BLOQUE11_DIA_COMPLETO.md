...
> **Decisión:** `.MANUALES/BLOQUES/MINERVA_BLOQUE11_DECISION_CALENDARIO_CONTENEDOR.md` §26–27  
...
**Comunicación planta:** `.MANUALES/BRIEFS/MINERVA_BLOQUE11_BRIEF_JORDI_CARLOS.md` v2 — pregunta **A/B** explícita (mantener dura auto vs volver a blando). **Pendiente respuesta Jordi/Carlos antes del merge.**
...
- `.MANUALES/MANUALES_USUARIO/MINERVA_MANUAL_CARTELAS_*`
- `.MANUALES/MANUALES_USUARIO/MINERVA_MANUAL_RESERVAS_*`
