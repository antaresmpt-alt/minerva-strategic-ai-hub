...
**Relacionado:** sobrantes → Bloque 6 · expedición → Bloque 7 · material contenedor/hijas → Bloque 8 · FSC → maestro artículos · **liberar/reasignar/STOP → `.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md` (9.8)**.
...
> Fuente completa: `.MANUALES/BRIEFS/MINERVA_CUESTIONARIO_CARTELAS_RAMON.md`. Este apartado resume **decisiones que cambian el diseño**.
...
**STOP / soltar palet de una OT (formato incorrecto, 18 ago):** no es el mismo flujo que “urgencias 100h OT-A → OT-B”. Liberar reserva + compra corrección + aviso CTP está en **`.MANUALES/BLOQUES/MINERVA_BLOQUE9_REASIGNACION_STOP.md` (fase 9.8)**. OT laboratorio **98019**.
...
**Permisos resultantes (resumen — detalle en `.MANUALES/BRIEFS/MINERVA_ROLES_Y_NAVEGACION.md`):**
...
| 24 jun 2026 | **§3g** — cuestionario Ramón respondido (`.MANUALES/BRIEFS/MINERVA_CUESTIONARIO_CARTELAS_RAMON.md`). **Modelo corregido:** 1 cartela = 1 palet = 1 ID Stock; varias OTs sin qty en cartela; Juan no cartela; consumo MVP obligatorio; I1 barco; **§13c** piloto paralelo 10–20 OTs; antiduplicado albarán; deprecado `palet_fisico_ref` / reparto N cartelas por palet. |
...
> Detalle técnico de lo desplegado. Para decisiones de negocio seguir §3g y `.MANUALES/BRIEFS/MINERVA_CUESTIONARIO_CARTELAS_RAMON.md`.
...
> **Sesión completa:** `.MANUALES/SESIONES/SESION_13AGO2026_DERIVAR_EXTERNA_ITINERARIO.md`. Commits: `1addf8d`, `622fc7b`. Prueba planta: OT **98015**.
...
| Docs | §3g, §7, §15.2, §15.6.3, `docs/referencias/cartelas-optimus-campo.md`, `.MANUALES/BRIEFS/GUIA_MAÑANA.md`, cuestionario Ramón |
...
> Detalle operativo: `.MANUALES/SESIONES/SESION_13AGO2026_DERIVAR_EXTERNA_ITINERARIO.md`. §15.6.12 cerrado.
...
> Detalle: `.MANUALES/SESIONES/SESION_14AGO2026_MANIPULADOS_ENCAJAR.md`. No cambia reglas de cartela 9.4.
