...
> Complementa a `.MANUALES/BRIEFS/MINERVA_BRIEFING.md`, `.MANUALES/CONTEXTO/MINERVA_CONTEXTO_TECNICO.md`,
> `.MANUALES/BLOQUES/MINERVA_BLOQUE6_HISTORICO_PRODUCIDAS.md` y `.MANUALES/CONTEXTO/FASES_HOJA_RUTA_DIGITAL.md`.
>
...
- cartelas de recepcion de material en palets (diseño §3b: `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` — kilos→hojas, FSC albarán proveedor).
...
--- BRIEFING ---
<pegar .MANUALES/BLOQUES/MINERVA_BLOQUE7_ODOO_ALBARANES.md>
```
