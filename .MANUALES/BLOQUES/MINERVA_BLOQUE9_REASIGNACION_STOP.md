...
> Complementa `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` (ATP, cartelas, consumo). Si hay contradicción sobre *liberar / recomprar / aviso formato*, **manda este documento**.
>
...
**Estado:** ✅ Implementado 20 ago tarde. Migración `20260820173000_bloque9_8_3_compra_correccion_schema.sql` + hook consumo `20260820173100_bloque9_8_3_consumo_salida_stop.sql`. Ver detalle en `.MANUALES/SESIONES/SESION_20AGO2026_BLOQUE9_8_3_VALIDACION_HOOK.md`.
...
> Detalle exhaustivo: **`.MANUALES/SESIONES/SESION_19AGO2026_STOP_MATERIAL_98020.md`**.
...
| Reasignación diseñada (sin UI) | `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md` §7.6 |
...
3. **Mañana 20 ago:** backlog §18 (cascade STOP + polish). Sesión: `.MANUALES/SESIONES/SESION_19AGO2026_STOP_MATERIAL_98020.md`.
...
> **Estado:** ✅ Completado 20 ago. `database.ts` generado (3774 líneas). Clientes cableados. Triage 44 errores: 0 P0, ~12 P1, ~32 P2. Ver `.MANUALES/SESIONES/SESION_20AGO2026_SUPABASE_TYPES_TRIAGE.md`.
