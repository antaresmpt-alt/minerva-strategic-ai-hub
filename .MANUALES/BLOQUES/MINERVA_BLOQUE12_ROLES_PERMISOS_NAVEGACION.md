...
> Diseño detallado (estado actual del código, ejes 1–3, límites): `.MANUALES/BRIEFS/MINERVA_ROLES_Y_NAVEGACION.md`.
>
...
**Complementa:** `.MANUALES/CONTEXTO/MINERVA_HUB_CONTEXTO_MAESTRO.md` · `.MANUALES/BRIEFS/MINERVA_ROLES_Y_NAVEGACION.md` · permisos almacén en `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md`.
...
- Eje 1: multi-rol / capacidades (`.MANUALES/BRIEFS/MINERVA_ROLES_Y_NAVEGACION.md` §A.3).
...
1. Leer `.MANUALES/BRIEFS/MINERVA_ROLES_Y_NAVEGACION.md` (Partes A–B) + este brief.
...
| 14 ago 2026 | Ramón: 1 tableta/máquina (no personal); turnos secuenciales. Lista gorda ejecución ya en `main` (admin aún ve menús). `.MANUALES/SESIONES/SESION_14AGO2026_EJECUCION_LISTA.md`. |
