...
> **Complementa:** `.MANUALES/BLOQUES/MINERVA_BLOQUE11_CALENDARIO_MAESTRO_LANZAMIENTO.md` · `.MANUALES/BLOQUES/MINERVA_BLOQUE11_ANALISIS_CONTENEDOR_VS_MESA.md` · `.MANUALES/BRIEFS/MINERVA_BLOQUE11_BRIEF_JORDI_CARLOS.md`
> **Código:** bandeja §5/§23 · contenedor CTP→…→I/D · hecho visual 26 ago · spike §6.5 → `.MANUALES/SESIONES/SESION_26AGO2026_BLOQUE11_SPIKE_DETALLE_DIA.md`
...
Sesión: `.MANUALES/SESIONES/SESION_26AGO2026_BLOQUE11_SPIKE_DETALLE_DIA.md` · migración: `supabase/migrations/20260826200000_prod_calendario_detalle_dia.sql` (**aplicada** en Supabase 26 ago).
...
- [ ] Validar brief Jordi/Carlos — **v2** `.MANUALES/BRIEFS/MINERVA_BLOQUE11_BRIEF_JORDI_CARLOS.md` (27 ago); leer **antes del domingo**; respuesta A/B reserva dura
...
- [x] **Spike persistencia detalle del día (§6.5) — cerrado 26 ago opción B** · `.MANUALES/SESIONES/SESION_26AGO2026_BLOQUE11_SPIKE_DETALLE_DIA.md`
...
**Rama:** `feature/bloque11-contenedor-ctp-spike`  
**Sesión:** `.MANUALES/SESIONES/SESION_23AGO2026_BLOQUE11_BANDEJA_SMOKE.md`
...
**Decisión B** — ver §6.5 completo + `.MANUALES/SESIONES/SESION_26AGO2026_BLOQUE11_SPIKE_DETALLE_DIA.md`.
...
Detalle exhaustivo + smoke: `.MANUALES/SESIONES/SESION_26AGO2026_BLOQUE11_SPIKE_DETALLE_DIA.md` §3.
...
Ver sesión §5 · `.MANUALES/SESIONES/SESION_27AGO2026_BLOQUE11_DIA_COMPLETO.md` §2 (orden Hoy).

---

## 27. Día completo 27 ago — PDF cartelas · Atrasadas modal · Guillotina · LEGACY

**Sesión exhaustiva:** `.MANUALES/SESIONES/SESION_27AGO2026_BLOQUE11_DIA_COMPLETO.md`  
...
**Doc:** `.MANUALES/BLOQUES/MINERVA_BLOQUE12_DETALLE_DIA_MESA.md` · sesión `.MANUALES/SESIONES/SESION_29AGO2026_BLOQUE12_DETALLE_DIA_MESA.md`.
