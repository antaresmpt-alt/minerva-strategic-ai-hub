...
> Complementa a `.MANUALES/CONTEXTO/FASES_HOJA_RUTA_DIGITAL.md`, `.MANUALES/CONTEXTO/FASES_MAESTRO_ARTICULOS.md` y `.MANUALES/CONTEXTO/MINERVA_HUB_CONTEXTO_MAESTRO.md`.
>
...
**Qué no mezclar:** no es 8.5 convergencia. Derivar 1/2 → 21 está en Bloque 9 §15.6.12 (`.MANUALES/SESIONES/SESION_13AGO2026_DERIVAR_EXTERNA_ITINERARIO.md`).
...
| **Cartelas / stock** | Bloque 9 — §3b: stock al recepcionar, kilos→hojas, ID Stock 10.300+; ver `.MANUALES/BLOQUES/MINERVA_BLOQUE9_MATERIAL_CARTELAS.md`. |
...
- Reunión Albert/Jordi: jueves — `.MANUALES/BRIEFS/MINERVA_REUNION_HOJA_RUTA_JUEVES.md`.
...
- **Manipulados:** etiquetar + paquetes. **14 ago:** Encajar + flags wizard (`.MANUALES/SESIONES/SESION_14AGO2026_MANIPULADOS_ENCAJAR.md`). Externos: captura envío/recepción ✅.
...
| Barco en ejecución | `.MANUALES/BRIEFS/GUIA_MAÑANA.md` · OT **98010** |
...
--- BRIEFING ---
<pegar .MANUALES/BLOQUES/MINERVA_BLOQUE8_FORMAS_Y_COMPONENTES.md>
```
