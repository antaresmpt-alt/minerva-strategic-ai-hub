...
> Complementa a `.MANUALES/BRIEFS/MINERVA_BRIEFING.md`, `.MANUALES/CONTEXTO/MINERVA_CONTEXTO_TECNICO.md` y `.MANUALES/CONTEXTO/FASES_HOJA_RUTA_DIGITAL.md`.
>
...
> **Prueba promedios:** `.MANUALES/BRIEFS/PLAN_PRUEBA_PROMEDIOS_MAESTRO.md` (1 OT × 4 réplicas).
...
1. **Promedios maestro** — ✅ Pasos A–D + UI + PDF ficha + **validación real 30 jul** (M-00003, Q=8000 en 98014). Ver `.MANUALES/BRIEFS/PLAN_PRUEBA_PROMEDIOS_MAESTRO.md`.
...
**Estado (23 jul 2026):** badge `pendiente_revision` + filtro rápido + KPI en
`planificacion-pipeline-tab.tsx` / `pipeline-query.ts`. Criterio: OT simple +
itinerario completo + sin fila activa en `prod_ot_producidas`.
...
**Resuelto en Ola 3** (ver `.MANUALES/CONTEXTO/FASES_MAESTRO_ARTICULOS.md` § Fase 2 / Ola 3):
...
Guía corta (1 OT base → 4 réplicas con horas distintas): **`.MANUALES/BRIEFS/PLAN_PRUEBA_PROMEDIOS_MAESTRO.md`**.
...
--- BRIEFING ---
<pegar .MANUALES/BLOQUES/MINERVA_BLOQUE6_HISTORICO_PRODUCIDAS.md>
```
