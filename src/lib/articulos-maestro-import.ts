      ...
      try {
        ...
        const parsed: ArticuloImportRow[] = rawRows.map((row) => {
          ...
          const parsedRow: ArticuloImportRow = {
            ...
            bultos_por_palet_habitual: parseOptionalInt(
          ...
          return setPresentFields(parsedRow, {
            ...
            bultos_por_palet_habitual: fieldPresent(
              row.bultos_por_palet_habitual,
            ),
...
const EXPORT_COLS = [
  ...
  { key: "bultos_por_palet_habitual", label: "bultos_por_palet_habitual" },
