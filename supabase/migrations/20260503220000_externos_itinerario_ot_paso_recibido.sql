-- Externos + itinerario: cola por paso externo disponible, vinculo ot_paso_id, avance al Recibido.
-- 1) Columna ot_paso_id en prod_seguimiento_externos
-- 2) RPC lista OTs cuyo primer paso disponible es proceso es_externo y sin seguimiento activo
-- 3) Trigger: al pasar estado a Recibido, cerrar paso y desbloquear siguiente (misma logica que mesa finaliza)
...
-- ---------------------------------------------------------------------------
-- RPC: OTs listas para entrar en externos (primer paso disponible = externo)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Trigger Recibido -> avanzar itinerario + pool
-- ---------------------------------------------------------------------------
