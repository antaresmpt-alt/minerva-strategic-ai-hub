...
insert into public.role_permissions (role, module_name, is_enabled) values
  ...
  ('comercial', 'sales', true), ('comercial', 'sem', true), ('comercial', 'seo', true), ('comercial', 'muelle', false), ('comercial', 'produccion', true), ('comercial', 'produccion_ejecucion', false), ('comercial', 'chat', true), ('comercial', 'settings', false),
  ...
  ('ctp', 'sales', false), ('ctp', 'sem', false), ('ctp', 'seo', false), ('ctp', 'muelle', false), ('ctp', 'produccion', true), ('ctp', 'produccion_ejecucion', true), ('ctp', 'chat', true), ('ctp', 'settings', false),
